...
from peptron.model.tri_self_attn_block import TriangularSelfAttentionBlock
        ...
        self.blocks = nn.ModuleList(
            [
                block(
                    ...
                    use_cuequivariance_attention=self.cfg.use_cuequivariance_attention,
                    use_cuequivariance_multiplicative_update=self.cfg.use_cuequivariance_multiplicative_update,
                )
