...
def enforce_config_constraints(config):
    ...
    if((config.globals.use_cuequivariance_attention or config.globals.use_cuequivariance_multiplicative_update) and not cueq_is_installed):
        raise ValueError("use_cuequivariance_attention or use_cuequivariance_multiplicative_update requires that cuequivariance-torch is installed")
...
def get_config(
    ...
    if name == "initial_training":
        ...
        c.model.heads.tm.enabled = True
        c.loss.tm.weight = 0.1
    elif name == "idp_finetuning_no_templ":
        c.data.train.crop_size = 384
        c.data.train.max_extra_msa = 5120
        c.data.train.max_msa_clusters = 512
        c.model.template.enabled = False
        ...
        c.loss.experimentally_resolved.weight = 0.01
        c.model.heads.tm.enabled = True
        c.loss.tm.weight = 0.05
        c.loss.distogram.weight = 0.2
        c.loss.fape.backbone.weight = 0.6
        c.loss.fape.sidechain.weight = 0.4
        c.loss.plddt_loss.weight = 0.02
        c.loss.masked_msa.weight = 1.0
        c.loss.supervised_chi.weight = 0.50
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
    elif name == "peptron_o_mixed":   
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
    ...
    elif name == "peptron_o_pdb_idrome":   
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
        c.data.train.crop_size = 512
        c.model.flow_matching.noise_prob = 0.9
        c.model.flow_matching.self_cond_prob = 0.0
        c.model.flow_matching.extra_input_prob = 0.5
    elif name == "peptron_o_pdb_idrome_violation":   
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
        c.data.train.crop_size = 512
    ...
    # INFERENCE PRESETS
        ...
        c.model.heads.tm.enabled = True
        c.loss.tm.weight = 0.1
    elif name == "peptron_o_pdb":   
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
    elif name == "peptron_o_idp":   
        c.model.flow_matching.noise_prob = 0.9
        c.model.flow_matching.self_cond_prob = 0.0
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
    elif name == "peptron_o_pdb_last_steps":   
        c.model.template.enabled = False
        c.data.common.max_recycling_iters = 0
        c.data.common.use_templates = False
        c.loss.violation.weight = 1.
...
trunk_chunk_size = mlc.FieldReference(None, field_type=int)
...
config = mlc.ConfigDict(
    {
        ...
        "training": {
            ...
            "initial_nemo_ckpt_path" : "<path-to-ckpt>",
            "train_data_dir_pdb" : "<path-to-pdb_mmcif_npz-dir>",
            "val_data_dir_pdb" : "<path-to-pdb_mmcif_npz-dir>",
            "val_data_dir_idp" : "<path-to-IDRome-val-dir>", # don't populate unless you want to change the validation strategy
            "train_msa_dir_pdb" : "<path-to-pdb-msa-dir>",
            "val_msa_dir_pdb" : "<path-to-cameo2022-msa-dir>",
            "val_msa_dir_idp" : "<path-to-IDRome-val-msa-dir>", # don't populate unless you want to change the validation strategy
            "train_chains_pdb" : "<path-to-peptron-repo>/splits/pdb_chains_msa.csv",
            "valid_chains_pdb" : "<path-to-peptron-repo>/splits/cameo2022_msa.csv",
            "valid_chains_idp" : "<path-to-peptron-repo>/splits/IDRome_DB-val-msa.csv", # don't populate unless you want to change the validation strategy
            "train_data_dir_idp" : "<path-to-IDRome-train-dir>",
            "train_msa_dir_idp" : "<path-to-IDRome-train-msa-dir>",
            "train_chains_idp" : "<path-to-peptron-repo>/splits/IDRome_DB-train-msa.csv",
            "mmcif_dir" : "<path-to-pdb_mmcif-dir>",
            "dataset_prob_pdb" : 0.3,
            "dataset_prob_idp" : 0.7,
            "train_clusters" : "<path-to-pdb_clusters>",
            "valid_clusters" : "<path-to-cameo2022_clusters>",
            "train_cutoff" : "2020-05-01",
            "sample_train_confs_pdb" : False,
            "sample_train_confs_idp" : True,
            "sample_val_confs_pdb" : False,
            "sample_val_confs_idp" : True,
            "first_as_template" : False,
            "num_val_confs_pdb" : None,
            "num_val_confs_idp" : 100,
            "filter_chains" : True, 
            "encoder_frozen": True,
